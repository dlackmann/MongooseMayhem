	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("direction") == null) {
			if (!dependencies.containsKey("direction"))
				MongooseMayhemMod.LOGGER.warn("Failed to load dependency direction for procedure BucketOSauceRightClickedOnBlock!");
			return;
		}
		...
		if (((direction == Direction.UP)
				&& (((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getBlock() == PizzaSauceBlock.block)
			...
			world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) z), PizzaSauceBlock.block.getDefaultState(), 3);
			if ((!(world.isRemote()))) {
				if ((Math.random() > 0.5)) {
			...
			if ((!(new Object() {
				...
				&& (((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z - 1)))).getBlock() == PizzaSauceBlock.block)
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) (z - 1)), PizzaSauceBlock.block.getDefaultState(), 3);
			if ((!(world.isRemote()))) {
				if ((Math.random() > 0.5)) {
					if (world instanceof World && !world.isRemote()) {
			...
			if ((!(new Object() {
				...
				&& (((world.getBlockState(new BlockPos((int) (x + 1), (int) y, (int) z))).getBlock() == PizzaSauceBlock.block)
			...
			world.setBlockState(new BlockPos((int) (x + 1), (int) y, (int) z), PizzaSauceBlock.block.getDefaultState(), 3);
			if ((!(world.isRemote()))) {
				if ((Math.random() > 0.5)) {
					if (world instanceof World && !world.isRemote()) {
