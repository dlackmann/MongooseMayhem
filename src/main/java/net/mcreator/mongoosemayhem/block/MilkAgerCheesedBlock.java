...
import net.mcreator.mongoosemayhem.procedures.MilkAgerCheesedOnBlockRightClickedProcedure;
...
public class MilkAgerCheesedBlock extends MongooseMayhemModElements.ModElement {
	@ObjectHolder("mongoose_mayhem:milk_ager_cheesed")
	public static final Block block = null;
	public MilkAgerCheesedBlock(MongooseMayhemModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("milk_ager_cheesed");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				MilkAgerCheesedOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
