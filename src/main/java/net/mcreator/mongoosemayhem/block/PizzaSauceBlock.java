...
public class PizzaSauceBlock extends MongooseMayhemModElements.ModElement {
	@ObjectHolder("mongoose_mayhem:pizza_sauce")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("mongoose_mayhem:pizza_sauce_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public PizzaSauceBlock(MongooseMayhemModElements instance) {
		super(instance, 36);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pizza_sauce_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mongoose_mayhem:pizza_sauce_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
