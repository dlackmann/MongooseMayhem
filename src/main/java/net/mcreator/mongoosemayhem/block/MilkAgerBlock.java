...
import net.mcreator.mongoosemayhem.procedures.MilkAgerOnBlockRightClickedProcedure;
...
public class MilkAgerBlock extends MongooseMayhemModElements.ModElement {
	@ObjectHolder("mongoose_mayhem:milk_ager")
	public static final Block block = null;
	public MilkAgerBlock(MongooseMayhemModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("For fermenting cheese"));
			list.add(new StringTextComponent("stanky business"));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				MilkAgerOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
