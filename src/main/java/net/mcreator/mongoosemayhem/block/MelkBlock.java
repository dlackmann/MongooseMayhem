...
public class MelkBlock extends MongooseMayhemModElements.ModElement {
	@ObjectHolder("mongoose_mayhem:melk")
	...
	public MelkBlock(MongooseMayhemModElements instance) {
		super(instance, 39);
	...
	public void initElements() {
		...
		elements.blocks.add(() -> new FlowingFluidBlock(still,
				Block.Properties.create(Material.WATER, MaterialColor.SNOW).hardnessAndResistance(100f).setLightLevel(s -> 0)) {
			@Override
